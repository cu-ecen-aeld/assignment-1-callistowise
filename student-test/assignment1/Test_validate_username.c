...
void test_validate_my_username()
{
     ...
     */
    const char* name_file = my_username();
    const char* name_autotest = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(name_file, name_autotest,"String output mismatch");
